...
#  filter(Reach %in% c("UNF3","UNF2","UNF1","MNF4","LNF1","DC4","HC3","SC3"))
#NF_geo_rch_label_left = NF_geo_reach_chnk %>%
#  filter(Reach %in% c("MNF3","MNF2","MNF1"))
#NF_geo_rch_label_up = NF_geo_reach_chnk %>%
#  filter(Reach %in% c("TC3","TC2","TC1","HC2","HC1","DC1","DC2","DC3","SC1","SC2","SC4"))
#NF_geo_rch_label_rtdwn = NF_geo_reach_chnk %>%
