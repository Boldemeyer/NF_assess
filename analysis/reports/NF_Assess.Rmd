...
```{r chnk-maps, fig.cap = "Extrapolations of habitat capacity for Chinook salmon, by life-stage, for eight watersheds within the Upper Salmon River Basin."}
ggarrange(chnk_US_sum_map,
          chnk_US_win_map,
          chnk_US_redd_map)
...
```{r sthd-maps, fig.cap = "Extrapolations of habitat capacity for steelhead, by life-stage, for eight watersheds within the Upper Salmon River Basin."}
ggarrange(sthd_US_sum_map,
          sthd_US_win_map,
          sthd_US_redd_map)
