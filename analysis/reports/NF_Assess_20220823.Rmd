...
#          S32_2080D) %>%
#   mutate(S2_02_11 = replace(S2_02_11, S2_02_11 == -9999.00, NA),
#          S30_2040D = replace(S2_02_11, S2_02_11 == -9999.00, NA),
#          S32_2080D = replace(S2_02_11, S2_02_11 == -9999.00, NA)) %>%
#   mutate(cur_min1 = S2_02_11 - 1) %>%
#   mutate(ao_chnk_spawn_cur = ifelse(S2_02_11 > 14.5, T, F),
#          ao_chnk_spawn_2040 = ifelse(S2_02_11 > 14.5, T, F),
#          ao_chnk_spawn_2080 = ifelse(S2_02_11 > 14.5, T, F),
#          ao_chnk_spawn_min1 = ifelse(S2_02_11 > 14.5, T, F),
#          ao_chnk_rear_cur = ifelse(S2_02_11 > 16, T, F),
#          ao_chnk_rear_2040 = ifelse(S2_02_11 > 16, T, F),
#          ao_chnk_rear_2080 = ifelse(S2_02_11 > 16, T, F),
#          ao_chnk_rear_min1 = ifelse(S2_02_11 > 16, T, F),
#          ao_sthd_spawn_cur = ifelse(S2_02_11 > 18, T, F),
#          ao_sthd_spawn_2040 = ifelse(S2_02_11 > 18, T, F),
#          ao_sthd_spawn_2080 = ifelse(S2_02_11 > 18, T, F),
#          ao_sthd_spawn_min1 = ifelse(S2_02_11 > 18, T, F))
